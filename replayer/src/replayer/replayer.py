...
class Replayer:
    ...
    def ran_syscall_result_callback(self, sys_call_index: int, syscall_result: int):
        ...
        if syscall_result != expected_return_value:
            print(f"Unexpected syscall result {syscall_result}, expected {expected_return_value}")

    def has_supported_syscall_runner_for_system_call(self, sys_call_index: int, sys_call_number: int) -> bool:
        """
    ...
    def simulate_system_call_handler(self, sys_call_index: int, sys_call_number: int = None, *registers) -> int:
        ...
        system_call_runner = system_call_runner_cls(sys_call_number, current_register_values, system_call)
